...
def get_testing_overrides() -> Dict[Callable, Callable]:
    ...
    ret: Dict[Callable, Callable] = {
        ...
        torch.split: lambda tensor, split_size_or_sections, dim=0, drop_remainder=False: -1,
        torch.split_with_sizes: lambda tensor, split_size_or_sections, dim=0, drop_remainder=False: -1,
